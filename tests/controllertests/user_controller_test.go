...
import (
	...
	"github.com/slns/fullstack/api/models"
...
func TestCreateUser(t *testing.T) {
	...
	samples := []struct {
		...
		{
			inputJSON:    `{"nickname":"Pet", "email": "test@gmail.com", "password": "password"}`,
			statusCode:   201,
			nickname:     "Test",
		...
		{
			inputJSON:    `{"nickname":"Test3", "email": "test@gmail.com", "password": "password"}`,
			statusCode:   500,
			errorMessage: "Email Already Taken",
		},
		{
			inputJSON:    `{"nickname":"Test", "email": "grand@gmail.com", "password": "password"}`,
			statusCode:   500,
			errorMessage: "Nickname Already Taken",
		},
		{
			inputJSON:    `{"nickname":"Kan", "email": "test3.com", "password": "password"}`,
			statusCode:   422,
			errorMessage: "Invalid Email",
		},
		{
			inputJSON:    `{"nickname": "", "email": "test@gmail.com", "password": "password"}`,
			statusCode:   422,
			errorMessage: "Required Nickname",
		},
		{
			inputJSON:    `{"nickname": "Test", "email": "", "password": "password"}`,
			statusCode:   422,
			errorMessage: "Required Email",
		},
		{
			inputJSON:    `{"nickname": "Test3", "email": "test3@gmail.com", "password": ""}`,
			statusCode:   422,
...
func TestUpdateUser(t *testing.T) {
	...
	samples := []struct {
	...
	}{
		{
			...
			statusCode:     200,
			updateNickname: "Test4",
			updateEmail:    "test4@gmail.com",
		...
		{
			// Remember "Ivops@gmail.com" belongs to user 2
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"nickname":"Ivo", "email": "ivops@gmail.com", "password": "password"}`,
			statusCode:   500,
			tokenGiven:   tokenString,
			errorMessage: "Email Already Taken",
		},
		{
			// Remember "Ivo Santo" belongs to user 2
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"nickname":"Ivo Santos", "email": "grand@gmail.com", "password": "password"}`,
			statusCode:   500,
			tokenGiven:   tokenString,
			errorMessage: "Nickname Already Taken",
		},
